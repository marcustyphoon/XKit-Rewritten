...
import { getTimelineItemWrapper, postSelector } from '../util/interface.js';
...
const getPostsFormId = 'xkit-mass_labeler-bulk-get-posts';

const createBlogOption = ({ name, title, uuid }) => dom('option', { value: uuid, title }, null, [name]);
const createTagSpan = tag => dom('span', { class: 'mass_labeler-bulk-tag' }, null, [tag]);
const createBlogSpan = name => dom('span', { class: 'mass_labeler-bulk-blog' }, null, [name]);
...
const buttonClass = 'xkit-mass_labeler-button';
const excludeClass = 'xkit-mass_labeler-done';
const warningClass = 'xkit-mass_labeler-warning';
...
const popupElement = dom('div', { id: 'mass_labeler' }, null, buttons);
